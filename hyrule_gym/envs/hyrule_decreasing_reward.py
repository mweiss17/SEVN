...
class HyruleDecreasingReward(HyruleBase):
    ...
    def __init__(self, obs_shape=(4, 84, 84), use_image_obs=True, use_gps_obs=False, use_visible_text_obs=True, use_full=False, reward_type=None):
        ...
        super(HyruleDecreasingReward, self).__init__(obs_shape, use_image_obs, False, use_visible_text_obs, use_full, reward_type)
